...
/**
 * The `INTableViewAdPlacer` class allows you to request native ads from the Instal ad server and
...
@interface INTableViewAdPlacer : NSObject
 ...
 * configure on the Instal website. In many cases, this is the preferred approach, since it allows
 ...
 * this as well.
 *
 * Alternatively, if you wish to hard-code your positions, you may pass an `INClientAdPositioning`
 * object instead.
 *
 ...
 * implement the `INNativeAdRendering` protocol and must be a subclass of `UITableViewCell`.
 *
 * @return An `INTableViewAdPlacer` object.
 */
+ (instancetype)placerWithTableView:(UITableView *)tableView viewController:(UIViewController *)controller adPositioning:(INClientAdPositioning *)positioning defaultAdRenderingClass:(Class)defaultAdRenderingClass;

/** @name Requesting Ads */

/**
 * Requests ads from the Instal ad server using the specified ad unit ID.
 *
...
/**
 * The Instal SDK adds interfaces to the `UITableView` class to help your application with
 * responsibilities related to `INTableViewAdPlacer`. These APIs include methods to help notify the
...
@interface UITableView (INTableViewAdPlacer)

- (void)in_setAdPlacer:(INTableViewAdPlacer *)placer;
 ...
 */
- (INTableViewAdPlacer *)in_adPlacer;
 ...
 */
- (void)in_setDataSource:(id<UITableViewDataSource>)dataSource;
 ...
 */
- (id<UITableViewDataSource>)in_dataSource;
 ...
 */
- (void)in_setDelegate:(id<UITableViewDelegate>)delegate;
 ...
 */
- (id<UITableViewDelegate>)in_delegate;
 ...
 */
- (void)in_insertRowsAtIndexPaths:(NSArray *)indexPaths withRowAnimation:(UITableViewRowAnimation)animation;
 ...
 */
- (void)in_deleteRowsAtIndexPaths:(NSArray *)indexPaths withRowAnimation:(UITableViewRowAnimation)animation;
 ...
 */
- (void)in_reloadRowsAtIndexPaths:(NSArray *)indexPaths withRowAnimation:(UITableViewRowAnimation)animation;
 ...
 * *indexPath*.
 */
- (void)in_moveRowAtIndexPath:(NSIndexPath *)indexPath toIndexPath:(NSIndexPath *)newIndexPath;
 ...
 */
- (void)in_insertSections:(NSIndexSet *)sections withRowAnimation:(UITableViewRowAnimation)animation;
 ...
 */
- (void)in_deleteSections:(NSIndexSet *)sections withRowAnimation:(UITableViewRowAnimation)animation;
 ...
 * @param animation A constant that indicates how the reloading is to be animated.
 */
- (void)in_reloadSections:(NSIndexSet *)sections withRowAnimation:(UITableViewRowAnimation)animation;
 ...
 * to make room for it.
 */
- (void)in_moveSection:(NSInteger)section toSection:(NSInteger)newSection;
 ...
 */
- (UITableViewCell *)in_cellForRowAtIndexPath:(NSIndexPath *)indexPath;
 ...
 */
- (id)in_dequeueReusableCellWithIdentifier:(NSString *)identifier forIndexPath:(NSIndexPath *)indexPath;
 ...
 * immediate.
 */
- (void)in_deselectRowAtIndexPath:(NSIndexPath *)indexPath animated:(BOOL)animated;
 ...
 */
- (NSIndexPath *)in_indexPathForCell:(UITableViewCell *)cell;
 ...
 */
- (NSIndexPath *)in_indexPathForRowAtPoint:(CGPoint)point;
 ...
 */
- (NSIndexPath *)in_indexPathForSelectedRow;
 ...
 */
- (NSArray *)in_indexPathsForRowsInRect:(CGRect)rect;
 ...
 */
- (NSArray *)in_indexPathsForSelectedRows;
 ...
 */
- (NSArray *)in_indexPathsForVisibleRows;
 ...
 */
- (CGRect)in_rectForRowAtIndexPath:(NSIndexPath *)indexPath;
 ...
 * immediate.
 */
- (void)in_scrollToRowAtIndexPath:(NSIndexPath *)indexPath atScrollPosition:(UITableViewScrollPosition)scrollPosition animated:(BOOL)animated;
 ...
 */
- (void)in_selectRowAtIndexPath:(NSIndexPath *)indexPath animated:(BOOL)animated scrollPosition:(UITableViewScrollPosition)scrollPosition;
