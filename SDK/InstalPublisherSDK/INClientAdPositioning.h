...
/**
 * The `INClientAdPositioning` class is a model that allows you to control the positions where
 ...
 * information from the Instal ad server, client ad positioning does not allow you to control your ad
 * positions via the Instal website.
 */

@interface INClientAdPositioning : NSObject <NSCopying>
